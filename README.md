...
- Build date: 2016-09-27T12:48:34.354-04:00
...
```
(for development, run `gem install --dev ./wheniwork-ruby-1.2.0.gem` to install the development dependencies)
...
*WhenIWork::DefaultApi* | [**get_times**](docs/DefaultApi.md#get_times) | **GET** /times | 
*WhenIWork::DefaultApi* | [**get_user**](docs/DefaultApi.md#get_user) | **GET** /users/{user-id} | 
*WhenIWork::DefaultApi* | [**get_users**](docs/DefaultApi.md#get_users) | **GET** /users | 


## Documentation for Models

 - [WhenIWork::Position](docs/Position.md)
 - [WhenIWork::PositionsResponse](docs/PositionsResponse.md)
 - [WhenIWork::Shift](docs/Shift.md)
 - [WhenIWork::ShiftResponse](docs/ShiftResponse.md)
