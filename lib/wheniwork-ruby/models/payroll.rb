...
module WhenIWork
  class Payroll
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'is_edited')
      ...
      if attributes.has_key?(:'is_finalized')
        self.is_finalized = attributes[:'is_finalized']
      end
    ...
    def hash
      [id, account_id, creator_id, start_date, end_date, notes, is_edited, is_closed, is_finalized, finalized_at, created_at, updated_at].hash
    end
